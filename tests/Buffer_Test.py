...
class TestBuffer:
    ...
    def test_lengthOfLine(self):
        text = "1\n22\n333"
        self.buffer.fill(text)
        assert self.buffer.lengthOfLine(3) == 3
    ...
    def test__checkBufferBoundsPlus1_positiveException(self):
        text = "1\n2\n3"
        self.buffer.fill(text)
        self.buffer._checkBufferBoundsPlus1(5)
    ...
    def test_copyLines(self):
        text = "1\n2\n3\n4"
        self.buffer.fill(text)
        assert self.buffer.copyLines(2, 2) == "2\n3"

    def test_copyAllLines(self):
        text = "1\n2\n3\n4"
        self.buffer.fill(text)
        assert self.buffer.copyLines(1, 4) == text

    def test_copyNullLines(self):
        text = "1\n2\n3\n4"
        self.buffer.fill(text)
        assert self.buffer.copyLines(1, 0) == ""

    def test_copyFromLine(self):
        text = "1\n1234"
        self.buffer.fill(text)
        assert self.buffer.copyFromLine((2,2),2) == "23"

    def test_copyAllFromLine(self):
        text = "1\n1234"
        self.buffer.fill(text)
        assert self.buffer.copyFromLine((2,1),4) == "1234"

    def test_copyNullFromLine(self):
        text = "1\n123"
        self.buffer.fill(text)
        assert self.buffer.copyFromLine((1,1),0) == ""
    ...
    def test_copyRange_inLine(self):
        ...
        expect = "def"
        assert self.buffer.copyRange((2,1), (2,3)) == expect

    def test_copyRange_withoutBody(self):
        text = "abc\ndef\nghi\njkl"
        self.buffer.fill(text)
        expect = "ef\ngh"
        assert self.buffer.copyRange((2,2), (3,2)) == expect

    def test_copyRange_withBody(self):
        text = "abc\ndef\nghi\njkl"
        self.buffer.fill(text)
        expect = "ef\nghi\njk"
        assert self.buffer.copyRange((2,2), (4,2)) == expect

    def test_copyRange_onlyBody(self):
        text = "abc\ndef\nghi\njkl"
        self.buffer.fill(text)
        expect = "def\nghi"
        assert self.buffer.copyRange((2,1), (3,3)) == expect
    ...
    def test_deleteFromLine(self):
        ...
        expect = "0\nade\n3"
        self.buffer.fill(text)
        self.buffer.deleteFromLine((2,2),2)
        assert str(self.buffer) == expect
    ...
    def test_deleteAllFromLine(self):
        ...
        expect = "0\n\n3"
        self.buffer.fill(text)
        self.buffer.deleteFromLine((2,1),5)
        assert str(self.buffer) == expect
    ...
    def test_deleteNullFromLine(self):
        ...
        expect = text
        self.buffer.fill(text)
        self.buffer.deleteFromLine((1,1),0)
        assert str(self.buffer) == expect
    ...
    def test_deleteRange_inLine(self):
        ...
        self.buffer.fill(text)
        expect = "abc\ndf\nghi"
        self.buffer.deleteRange((2,2), (2,2))
        assert str(self.buffer) == expect
        text = "abc\ndef\nghi"
        self.buffer.fill(text)
        expect = "abc\n\nghi"
        self.buffer.deleteRange((2,1), (2,3))
        assert str(self.buffer) == expect
    ...
    def test_deleteRange_withoutBody(self):
        ...
        self.buffer.fill(text)
        expect = "abc\ndi\njkl"
        self.buffer.deleteRange((2,2), (3,2))
        assert str(self.buffer) == expect
    ...
    def test_deleteRange_withBody(self):
        ...
        self.buffer.fill(text)
        expect = "al"
        self.buffer.deleteRange((1,2), (4,2))
        assert str(self.buffer) == expect
    ...
    def test_insertLinesBetween(self):
        ...
        self.buffer.insertLines(2, text)
        assert str(self.buffer) == expect
    ...
    def test_insertLinesAtBottom(self):
        ...
        expect = "1\n2\n3\na\nb"
        self.buffer.fill(prefill)
        self.buffer.insertLines(4, text)
        assert str(self.buffer) == expect
